  ...
  <div class="py-16 bg-gray-50 overflow-hidden lg:py-24">
    <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
      ...
      <div class="relative">
        ...
        >A better way to get your coffee</h3>
        <p
          class="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500"
        >We provide consistently excellent coffee that is roasted and distributed in the United States.</p>
      </div>
      ...
      <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        <div class="relative">
          ...
          >High quality blends</h4>
          <p
            class="mt-3 text-lg leading-7 text-gray-500"
          >Buddy Joe Coffee co. provides the highest quality blends from Temecula, California</p>
          ...
          <ul class="mt-10">
            <li>
              <div class="flex">
                ...
                <div class="ml-4">
                  <h5 class="text-lg leading-6 font-medium text-gray-900">Temecula, California</h5>
                  <p
            ...
            <li class="mt-10">
              <div class="flex">
                ...
                <div class="ml-4">
                  <h5 class="text-lg leading-6 font-medium text-gray-900">Fresh, domestic beans</h5>
                  <p
                    class="mt-2 text-base leading-6 text-gray-500"
                  >Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
                </div>
            ...
            <li class="mt-10">
              <div class="flex">
                ...
                <div class="ml-4">
                  <h5 class="text-lg leading-6 font-medium text-gray-900">Variety of blends</h5>
                  <p
                    class="mt-2 text-base leading-6 text-gray-500"
                  >Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
                </div>
        ...
        <div class="mt-10 -mx-4 relative lg:mt-0">
          ...
          <img
            ...
            width="490"
            src="https://images.unsplash.com/photo-1549420751-ea3f7ab42006?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1234&q=80"
            alt
          />
        </div>
      </div>
