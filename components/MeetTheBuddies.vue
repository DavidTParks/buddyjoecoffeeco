  ...
  <div class="py-16 bg-gray-50 overflow-hidden lg:py-24">
    ...
    >
      ...
      <div class="relative">
        ...
        >
          We provide consistently excellent coffee that is roasted and distributed in the United States.
        </p>
      </div>
      ...
      >
        <div class="relative">
          ...
          <p class="mt-3 text-lg leading-7 text-gray-500">
            The Breakfast Blend is our signature coffee, a medium roast that provides the perfect jump-start to your day. Groggy? Tired? Cashed? Whip yourself into shape with a cup of Joe's finest -- it is a win with every sip.
          </p>
        </div>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        ...
        >
          <div class="lg:col-start-2">
            ...
            <p class="mt-3 text-lg leading-7 text-gray-500">
              A dark and medium roast, the Cowboy Blend features notes of cocoa and caramel with subtle vanilla tones. It is the favored choice of ranchers and cattlemen across the country, a refreshing coffee best enjoyed before you ride off into the sunset.
            </p>
          </div>
      ...
      >
        <div class="relative">
          ...
          <p class="mt-3 text-lg leading-7 text-gray-500">
            Our darkest coffee, the French Roast mixes the intensity of dark chocolate with the sweetness of cool caramel. As they say in la Republiqué, "Ah, oui, oui, délicieux!"
          </p>
        </div>
