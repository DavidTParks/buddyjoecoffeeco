    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <template v-else>
        ...
        <div class="flex flex-col pt-4 py-12 sm:flex-row">
          <div class="w-full sm:w-1/2">
            <img
              ...
              :src="$shopify.image.helpers.imageForSize(candle.variants[0].image, {maxWidth: 1000, maxHeight: 1000})"
          ...
          <div class="w-full sm:w-1/2 px-4 sm:px-6 lg:px-8 mt-4 sm:mt-0">
            ...
            <div class="flex items-center justify-center flex-col mt-12">
              ...
              >
                Add To Cart
                <template
                  v-if="cartItemsLoading.length > 0 && cartItemsLoading.indexOf(candle.variants[0].id) !== -1"
                >
                  <svg
        ...
        <div class="py-12">
          ...
          >Related Products</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-4 sm:mt-12">
